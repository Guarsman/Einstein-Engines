id-card-console-window-privileged-id = Привилегированный ID:
...
id-card-console-window-job-selection-label = Шаблоны должностей (устанавливают отдел и иконку):

access-id-card-console-component-no-hands-error = У вас нет рук.
id-card-console-privileged-id = Привилегированный ID
