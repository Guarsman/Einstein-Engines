...
supermatter-console-window-label-power = Внутр. энергия:
supermatter-console-window-label-power-bar = {$power} {$prefix}эВ

supermatter-console-window-label-radiation = Радиация:
...
supermatter-console-window-label-waste = Мультипликатор отходов:
...
supermatter-console-window-flavor-left = ⚠ Не приближаться к кристаллу
