guidebook-reagent-effect-description =
    {$chance ->
        [1] { $effect }
        *[other] Имеет { NATURALPERCENT($chance, 2) } вероятность { $effect }
    }{ $conditionCount ->
        [0] .
        *[other] {" "}при условии, что { $conditions }.
    }
...
guidebook-reagent-physical-description = [italic]Выглядит как {$description}.[/italic]
guidebook-reagent-recipes-mix-info = {$minTemp ->
    ...
    *[other] {CAPITALIZE($verb)} {$hasMax ->
            [true] в диапазоне от {NATURALFIXED($minTemp, 2)}K до {NATURALFIXED($maxTemp, 2)}K
