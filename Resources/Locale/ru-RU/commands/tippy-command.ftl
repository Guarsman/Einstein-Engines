cmd-tippy-desc = Отправить сообщение от лица клоуна Типпи.
cmd-tippy-help = tippy <пользователь | all> <сообщение> [прототип сущности] [время речи] [время скольжения] [интервал шатания]
