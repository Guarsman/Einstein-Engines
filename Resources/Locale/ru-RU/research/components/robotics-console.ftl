...
robotics-console-no-cyborgs = Нет киборгов!
...
robotics-console-locked-message = Управление заблокировано, проведите ID.
robotics-console-disable = Отключить
robotics-console-destroy = Уничтожить

robotics-console-cyborg-destroying = {$name} готовится к дистанционному подрыву!