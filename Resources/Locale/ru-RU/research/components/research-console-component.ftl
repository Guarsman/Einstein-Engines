...
research-console-menu-server-sync-button = Синхронизация
...
research-console-unlock-technology-radio-broadcast = Разблокирована технология [bold]{$technology}[/bold] за [bold]{$amount}[/bold] очков исследований. Утвердил: [bold]{$approver}[/bold].