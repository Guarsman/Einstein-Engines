...
shared-solution-container-component-on-examine-main-text = Содержит {INDEFINITE($desc)} [color={$color}]{$desc}[/color] {$wordedAmount}
...
examinable-solution-has-recognizable-chemicals = В растворе вы распознаете {$recognizedString}.
