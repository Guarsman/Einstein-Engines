atmos-alerts-window-title = Компьютер атмосферных тревог
...
atmos-alerts-window-total-mol-label = Общее количество молей
...
atmos-alerts-window-oxygenation-label = Кислород
...
atmos-alerts-window-other-gases-value-nil = Отсутствуют
atmos-alerts-window-silence-alerts = Отключить тревоги

atmos-alerts-window-label-alert-types = Уровни тревоги:
atmos-alerts-window-normal-state = Норма
...
atmos-alerts-window-no-active-alerts = [font size=16][color=white]Нет активных тревог -[/color] [color={$color}]Ситуация в норме[/color][/font]
atmos-alerts-window-no-data-available = Нет данных
atmos-alerts-window-alerts-being-silenced = Отключение тревог...

atmos-alerts-window-toggle-overlays = Переключить отображение тревог

atmos-alerts-window-flavor-left = Для помощи обратитесь к атмосферному технику
