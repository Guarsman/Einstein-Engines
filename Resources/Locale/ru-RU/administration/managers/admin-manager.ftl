admin-manager-self-de-admin-message = {$exAdminName} снял(а) с себя права администратора.
admin-manager-self-re-admin-message = {$newAdminName} вернул(а) себе права администратора.
...
admin-manager-self-enable-stealth = {$stealthAdminName} теперь скрыт(а).
admin-manager-self-disable-stealth = {$exStealthAdminName} больше не скрыт(а).