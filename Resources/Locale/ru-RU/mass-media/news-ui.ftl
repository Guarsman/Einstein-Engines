...
news-read-ui-next-tooltip = Вперёд
...
news-write-ui-preview-text = Превью
...
news-write-ui-richtext-tooltip = Новости поддерживают форматирование
...
news-pda-notification-header = Новая новость