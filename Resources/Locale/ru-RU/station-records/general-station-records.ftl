general-station-record-console-window-title = Компьютер станционных записей
...
general-station-record-console-no-record-found = Для выбранного человека запись не найдена.
...
general-station-record-console-reset-filters = Сбросить
